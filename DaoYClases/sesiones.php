...
{
    return isset($_REQUEST['usuario']);
}

function vieneCookieRecuerdame()
{
    return isset($_COOKIE["codigoCookie"]);
}
...
function garantizarSesion()
{
    ...
    if (haySesionIniciada()) {
        ...
        if (vieneCookieRecuerdame()) {
            ...
            $cliente = DAO::clienteObtenerPorEmailYCokie($email, $codigoCookie); // TODO Hacer esto con DAO.
            ...
            echo"por alli";
            $cliente = DAO::clienteObtenerPorUsuarioYContrasenna($_REQUEST['usuario'], $_REQUEST['contrasenna']);
