					...
					<div class="panel-body" >
						...
						<form id="signupform" class="form-horizontal" role="form" action="gestionar_registro.php" method="POST" autocomplete="off">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input type="text" class="form-control" name="nombreUsuario" placeholder="Usuario" value="<?php if(isset($usuario)) echo $usuario; ?>" required>
								</div>
							</div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="g-recaptcha col-md-9" data-sitekey="6LfsnuwUAAAAAPJ50ZZ1POX1vF5jXyCNv9Lpxngf"></div>
                            </div>
