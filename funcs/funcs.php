<?php
	...
	function emailExiste($email)
	{
		...
		$stmt = $mysqli->prepare("SELECT id FROM usuarios WHERE correoElectronico = ? LIMIT 1");
	...
	function registraUsuario($usuario, $pass_hash, $nombre, $email, $activo, $token, $tipo_usuario){
		...
		$stmt = $mysqli->prepare("INSERT INTO usuarios (Nombre, correoElectronico, contrasenna, tipousuario) VALUES(?,?,?)");
	...
	function login($usuario, $password)
	{
		...
		$stmt = $mysqli->prepare("SELECT id, tipoUsuario, contrasenna FROM usuarios WHERE nombre = ? || correoElectronico = ? LIMIT 1");
